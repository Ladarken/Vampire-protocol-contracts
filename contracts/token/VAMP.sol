...
contract VAMPToken is VAMPTokenInterface {
    ...
    */
    ...
    function _mint(address to, uint256 amount) internal {
        ...
        uint256 VAMPValue = amount.mul(internalDecimals).div(scalingFactor);

        // increase initSupply
        initSupply = initSupply.add(VAMPValue);
    ...
    */
    ...
    returns (bool)
    {
        ...
        uint256 VAMPValue = value.mul(internalDecimals).div(scalingFactor);

        // sub from balance of sender
        _VAMPBalances[msg.sender] = _VAMPBalances[msg.sender].sub(VAMPValue);
