...
import "./VAMPDelegate.sol";

contract VAMPDelegator is VAMPTokenInterface, VAMPDelegatorInterface {
    /**
     * @notice Construct a new VAMP
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "VAMPDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"VAMPDelegator:fallback: cannot send value to fallback");
